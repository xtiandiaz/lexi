const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AboutView-DY6ofkJH.js","assets/AboutView-CSIvawM9.css"])))=>i.map(i=>d[i]);
...
`));return(t,r)=>(Bn(),Vn("main",null,[Pe("ul",null,[(Bn(!0),Vn(Se,null,Qs(n.value,(o,i)=>(Bn(),Vn("li",{key:i},dr(o),1))),128))])]))}}),Cc=pc({history:Ul("/lexicon/vue"),routes:[{path:"/",name:"home",component:Pc},{path:"/about",name:"about",component:()=>Sc(()=>import("./AboutView-DY6ofkJH.js"),__vite__mapDeps([0,1]))}]}),jr=al(xc);jr.use(dl());jr.use(Cc);jr.mount("#app");export{ki as _,Pe as a,Vn as c,Bn as o};
