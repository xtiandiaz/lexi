...
export default new Map<LocalizedString, string>([
  [LocalizedString.Button_Test, "Evaluar"],
  [LocalizedString.DailyGoal, "Meta Diaria"],
  [LocalizedString.Language, "Idioma"],
  [LocalizedString.LanguageName, "Español"],
  [LocalizedString.Text_DailyGoalReached, "¡Haz logrado tu Meta Diaria!"],
  [LocalizedString.Title_DailyHistory, "Historial de Hoy"],
  [LocalizedString.Title_Settings, "Configuración"],
  [LocalizedString.Title_DailyGoalReached, "¡Meta Diaria alcanzada!"],
  [LocalizedString.Word, "palabra"]
])
